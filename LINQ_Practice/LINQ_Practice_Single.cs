...
namespace LINQ_Practice
{
        ...
        */
    {
        ...
        {
            var ActualCohort = PracticeData.Single(c => c.JuniorInstructors.Count().Equals(3));
        ...
        {
            var ActualCohort = PracticeData.Single(c => c.FullTime && c.PrimaryInstructor.Birthday.Year > 2018);
        ...
        {
            var ActualCohort = PracticeData.SingleOrDefault(c => c.PrimaryInstructor.FirstName.Equals("Zelda"));
        ...
        {
            var shouldThrowException = PracticeData.Single(c => c.JuniorInstructors.Count().Equals(2));
        }
    }
}
