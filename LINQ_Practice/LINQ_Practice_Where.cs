...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Where
    {
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(c => c.PrimaryInstructor.FirstName.Equals("Jurnell")).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(c => c.JuniorInstructors.Count().Equals(3)).ToList();
